...
<?php
  ...
  $filtro= "SELECT Producto_idProducto,cantidadProducto,subtotal,
  producto.nombre,producto.descripcion,producto.costoCompra 
  FROM detallecompra, producto WHERE  compras_idcompras = '$compras_idcompras' 
  AND detallecompra.Producto_idProducto = producto.idProducto ORDER BY detallecompra.cantidadProducto";
