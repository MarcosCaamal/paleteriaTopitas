			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link" href="paginas/productoEm.php">Productos</a></li>
						<li class="nav-item"><a class="nav-link" href="paginas/ventasEm.php">Ventas</a></li>
						<li class="nav-item active"><a class="nav-link" href="actualizarusuario.php">Actualizar Perfil</a></li>
