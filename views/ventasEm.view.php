...
<div class="container-fluid ">
 <form method="post">
    <div class="form-group obtds">
        <label class="control-label tamla" for="totalProductoVendido">Producto Vendido:</label>
       <div class="col bg-info">
         <input type="text" class="form-control text-uppercase" id='totalProductoVendido' name="totalProductoVendido" placeholder="00"
           value="<?php  if(isset($_GET['editar'])) echo $getROW['totalProductoVendido'];  ?>" />
       </div>
    </div>

    <div class="form-group obtds">
       <label class="control-label tamla" for="fechaVenta">Fecha de Venta:</label>
       <div class="col">
    ...
    <div class="form-group obtds">
       <label class="control-label tamla" for="importeTotal">Importe Total:</label>
       <div class="col">
          <input type="text" class="form-control text-uppercase" name="importeTotal" placeholder="125"
          value="<?php if(isset($_GET['editar'])) echo $getROW['importeTotal'];  ?>" />
       </div>
    </div>
    <div class="form-group obtds">
       <label class="control-label tamla" for="descuento">Descuento:</label>
       <div class="col">
 ...
 <?php
  ...
  $filtro="SELECT * FROM ventas order by idVentas";
...
?>
 ...
 ?>
       <tr class="tabCont">
         ...
         <td><?php echo $row['totalProductoVendido']; ?></td>
         ...
         <td>
           ...
           <a href="?eliminar=<?php echo $row['idVentas']; ?>" onclick="return confirm('¿Seguro deseas eliminarlo?'); ">
